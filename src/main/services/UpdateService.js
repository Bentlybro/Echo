...
class UpdateService {
  ...
  async downloadAndInstallUpdate(updateInfo) {
    try {
      ...
      const result = await dialog.showMessageBox(this.mainWindow, {
        ...
        message: 'Echo update has been downloaded successfully.',
  ...
  downloadUpdate(downloadUrl) {
    return new Promise((resolve, reject) => {
      const fileName = `Echo-Update-${Date.now()}.exe`;
  ...
  scheduleUpdateOnRestart(updatePath) {
    ...
    dialog.showMessageBox(this.mainWindow, {
      ...
      message: 'The update will be installed when you next restart Echo.',
      buttons: ['OK']
    });
  }
  ...
  showNoUpdatesDialog() {
    dialog.showMessageBox(this.mainWindow, {
      ...
      message: 'You are running the latest version of Echo.',
